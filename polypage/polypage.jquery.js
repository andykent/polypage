...
(function($) {
	...
	$.polypage = {
		...
		buildOptionsBar: function(){
			...
			// it would be really cool if the object was sorted alphabetically 
			// currently it depends on the order of the classes in the page
			// in usability testing this inconsistancy could be confusing
