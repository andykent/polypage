...
(function($) {
  ...
  $.fn.polypage = function(opts) {
    ...
    this.ppBase(opts);
    if(opts.events) this.ppEvents();
    if(opts.gui) this.ppGUI();
    if(opts.cookie) this.ppCookie();
    return this
  };
  ...
  $.polypage.GUI.prototype = {
    ...
    bindWithPolypage: function(){
      ...
      if(this.polypage===undefined)
        throw "A polypage GUI object must be bound to a polypage enabled element, try setting the 'bindTo' option.";
    },
  ...
  $.fn.ppEvents = function(opts) {
    return this.each(function() {
      (opts = opts || {}).bindTo = opts.bindTo || this;
      $(this).data('ppEvents', new $.polypage.Events(this, opts)); 
    });
  };
  
  $.polypage.Events = function(scope, options) {
    this.scope = $(scope);
    this.options = $.extend($.polypage.Events.DEFAULTS, options||{});
    this.init();
  };
  
  $.polypage.Events.DEFAULTS = {
    enableClickEvents: true,
    enableSubmitEvents: true
  };
  
  $.polypage.Events.prototype = {
    init: function(){
      this.bindWithPolypage();
      this.bindEvents();
    },
    ...
    bindWithPolypage: function(){
      ...
      this.polypage = this.polypageScope.data('polypage');
      if(this.polypage===undefined)
        throw "A polypage Events object must be bound to a polypage enabled element, try setting the 'bindTo' option.";
    },
  ...
  $.fn.ppCookie = function(opts) {
    return this.each(function() {
      (opts = opts || {}).bindTo = opts.bindTo || this;
      $(this).data('ppCookie', new $.polypage.Cookie(this, opts));
    });
  };
  
  $.polypage.Cookie = function(scope, options) {
    this.scope = $(scope);
    this.options = $.extend($.polypage.Cookie.DEFAULTS, options||{});
    this.init();
  };
  
  $.polypage.Cookie.DEFAULTS = {
  };
  
  $.polypage.Cookie.prototype = {
    init: function(){
      this.bindWithPolypage();
    },
    ...
    bindWithPolypage: function(){
      ...
      this.polypage = this.polypageScope.data('polypage');
      if(this.polypage===undefined)
        throw "A polypage Cookie object must be bound to a polypage enabled element, try setting the 'bindTo' option.";
    }
  };
})(jQuery);